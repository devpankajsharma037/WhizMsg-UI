    ...
    <div className="mt-10 px-6 sm:mt-16 lg:px-8">
      <Container>
        <div className="mx-auto max-w-[700px] ">
          <h1 className="mt-2 text-center text-secondary text-5xl font-semibold tracking-tight text-secondary sm:text-6xl">
            Guide
          </h1>
          <div className="mt-10 lg:mt-14 transform: none; height: 100%;">
            {posts.map((post) => (
              <section key={post.id} className="your-section-class">
                <div>
                  <a
                    className="flex flex-col md:flex-row gap-8 p-2 sm:p-4 mb-8 border border-gray-300 scale-100 hover:scale-[1.025] hover:shadow-[0px_0px_20px_2px_#dcdcdc] transition-all rounded-lg"
                    href="/guide/whatsapp-notes/"
                  >
                    <div>
                      <img
                    ...
                    <div className="flex flex-col justify-between py-4">
                      ...
                      <h2 className="text-4xl text-black leading-[50px] font-poppins font-semibold hover:text-secondary my-4">
                        {post.title}
                      </h2>
